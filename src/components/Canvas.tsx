...
export const Canvas: React.FC<CanvasProps> = ({
  ...
  }, [handleCanvasMouseMove, draggedNode, connectionInProgress, zoom, canvasOffset.x, canvasOffset.y]);
...
bg-white/90 backdrop-blur-sm p-2 rounded-lg shadow-md border border-gray-200 flex items-center 
divide-x divide-gray-200">
          ...
          <div className="pl-3 flex items-center space-x-2 text-sm text-gray-700">
              ...
              <button onClick={handleZoomToFit} className="p-1 hover:bg-gray-100 rounded-md disabled:text-gray-300" disabled={nodes.length === 0} title="Zoom to Fit">
